...
```
As shown in the scatterplots above, there is a negative relationship between mortality rate with median household income (correlation of `r cor1`) as well as percentage of smokers (correlation of  `r cor3`). On the other hand, there is a positive relationship between the percentage of births that had a low birth weight in a county and the mortality rate in that county (correlation of `r cor3`). These relationships suggest a possibility of incorporating these factors as appropriate predictors in our model.  
