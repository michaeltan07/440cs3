...
[TODO: Update model comparison numbers (shouldn't change much, only difference was including year)]
...
[TODO: change this from a plot_model to a nice latex table with the coefficients. Should take up a lot less space and ]
...
#probably dont want to include these plots below
set_theme(axis.textsize.y = 0.3)
...
[TODO: Update numbers, mention year]
...
[TODO: add tableau screenshot 3]

[shift analysis towards trends, comparison with U.S. data, away from NCHS]
